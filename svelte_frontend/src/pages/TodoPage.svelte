<script lang="ts">
  ...
  let newTodoText = "";
  let cards: { id: number; content: string }[] = [
    { id: 0, content: "some todo text" },
  ];
...
<main class="flex flex-column items-center">
  <div class="flex">
    ...
    />
    <button class="rounded my2 mx1" id="submit1" on:click={submitPressed}
      >Submit</button
    >
  ...
  {#if !APIserverIsResponding}
    <div class="bg-red-300 rounded p1">
