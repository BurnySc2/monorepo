...
<main>
  <div class="my2 flex justify-center">
    <button class="m1 p1 rounded" id="home" on:click={() => setUrl("/")}
      >Home</button
    >
    <button class="m1 p1 rounded" id="about" on:click={() => setUrl("/about")}
      >About</button
    >
    <button class="m1 p1 rounded" id="chat" on:click={() => setUrl("/chat")}
      >Chat</button
    >
    <button class="m1 p1 rounded" id="todo" on:click={() => setUrl("/todo")}
      >Todo</button
    >
    <button
      class="m1 p1 rounded"
      id="browserstorage"
      on:click={() => setUrl("/browserstorage")}>BrowserStorage</button
    >
  </div>
  {#if url === "/"}
    <Home />
