<script lang="ts">
    ...
    import { fetch_tracks, fetch_times } from "$lib/api_client"
    import type { Track, BestTimeEntry, DateRange, DriverSeries } from "$lib/types"
...
<div class="max-w-5xl mx-auto p-8">
    ...
    {:else if bestTimes.length === 0}
        <div class="text-center p-8 text-gray-500">
            No data available for the selected track and period.
        </div>
    {:else}
        <div
        ...
        >
            <BestTimeChart {series} {hoveredDate} />
        </div>
