...
VOICES = [
    ...
    VoiceInfo(
        name="en_male_santa_narration",
        short_name="beauty_guru",
        gender="Male",
        locale="en-us",
        language="English (US)",
        description="Beauty Guru",
    ),
    VoiceInfo(
        name="en_male_santa",
        short_name="santa",
    ...
    VoiceInfo(
        name="en_male_santa_effect",
        short_name="santa_wo_effect",
        gender="Male",
        locale="en-us",
        language="English (US)",
        description="Santa (No Effect)",
    ),
    VoiceInfo(
        name="en_female_richgirl",
        short_name="bestie",
        gender="Female",
        locale="en-us",
        language="English (US)",
    ...
    VoiceInfo(
        name="en_male_ukneighbor",
        short_name="lord_cringe",
        gender="Male",
        locale="en-uk",
        language="English (UK)",
        description="Lord Cringe",
    ),
    VoiceInfo(
        name="en_male_wizard",
        short_name="magician",
    ...
    VoiceInfo(
        name="en_female_shenna",
        short_name="debutante",
        gender="Female",
        locale="en-us",
        language="English (US)",
        description="Debutante",
    ),
    VoiceInfo(
        name="en_female_makeup",
        short_name="author",
        gender="Female",
        locale="en-us",
        language="English (US)",
    ...
    VoiceInfo(
        name="en_male_grinch",
        short_name="trickster_grinch",
        gender="Male",
        locale="en-us",
        language="English (US)",
        description="Trickster Grinch",
    ),
    VoiceInfo(
        name="en_male_deadpool",
        short_name="goodguy_deadpool",
        gender="Male",
        locale="en-us",
        language="English (US)",
        description="Good Guy Deadpool",
    ),
    VoiceInfo(
        name="en_male_ukbutler",
        short_name="meticulous",
        gender="Male",
        locale="en-uk",
        language="English (UK)",
    ...
    VoiceInfo(
        name="en_male_petercullen",
        short_name="optimus_prime",
        gender="Male",
        locale="en-us",
        language="English (US)",
    ...
    VoiceInfo(
        name="en_male_sing_deep_jingle",
        short_name="song_caroler",
        gender="Male",
        locale="en-us",
        language="English (US)",
        description="Song Caroler",
    ),
    VoiceInfo(
        name="en_male_m03_classical",
        short_name="song_classic_electric",
        gender="Male",
        locale="en-us",
        language="English (US)",
        description="Song Classic Electric",
    ),
    VoiceInfo(
        name="en_male_m2_xhxs_m03_christmas",
        short_name="song_cozy",
        gender="Male",
        locale="en-us",
        language="English (US)",
        description="Song Cozy",
    ),
    VoiceInfo(
        name="en_female_ht_f08_halloween",
        short_name="song_halloween",
        gender="Female",
        locale="en-us",
        language="English (US)",
        description="Song Halloween",
    ),
    VoiceInfo(
        name="en_female_ht_f08_newyear",
        short_name="song_nye_2023",
        gender="Female",
        locale="en-us",
        language="English (US)",
        description="Song NYE 2023",
    ),
    VoiceInfo(
        name="en_male_sing_funny_thanksgiving",
        short_name="song_thanksgiving",
        gender="Male",
        locale="en-us",
        language="English (US)",
        description="Song Thanksgiving",
    ),
    VoiceInfo(
        name="en_female_f08_twinkle",
        short_name="song_pop_lullaby",
        gender="Female",
        locale="en-us",
        language="English (US)",
        description="Song Pop Lullaby",
    ),
    # Additional Languages
    VoiceInfo(
        name="it_male_m18",
        short_name="italian_male",
        gender="Male",
        locale="it-it",
        language="Italian",
    ...
    VoiceInfo(
        name="es_female_f6",
        short_name="spanish_female_alejandra",
        gender="Female",
        locale="es-es",
        language="Spanish",
    ...
    VoiceInfo(
        name="es_female_fp1",
        short_name="spanish_female_mariana",
        gender="Female",
        locale="es-mx",
        language="Spanish (MX)",
    ...
    VoiceInfo(
        name="es_mx_male_transformer",
        short_name="mx_optimus_prime",
        gender="Male",
        locale="es-mx",
        language="Spanish (MX)",
        description="MX Optimus Prime",
    ),
    VoiceInfo(
        name="pt_female_lhays",
        short_name="portuguese_lhays_macedo",
        gender="Female",
        locale="pt-br",
        language="Portuguese (BR)",
        description="Portuguese Lhays Macedo",
    ),
    VoiceInfo(
        name="pt_female_laizza",
        short_name="portuguese_laizza",
        gender="Female",
        locale="pt-br",
        language="Portuguese (BR)",
        description="Portuguese Laizza",
    ),
    VoiceInfo(
        name="pt_male_transformer",
        short_name="pt_optimus_prime",
        gender="Male",
        locale="pt-br",
        language="Portuguese (BR)",
        description="PT Optimus Prime",
    ),
]
